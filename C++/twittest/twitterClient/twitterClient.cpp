...
int main( int argc, char* argv[] )
{
    ...
    twitterObj.getOAuth().setConsumerKey( std::string( "807520039989604352-dknPFPyJmZ32onym7guz3uzMa22j0vV" ) );
    twitterObj.getOAuth().setConsumerSecret( std::string( "f29bLHf49zn0zmIi84vdeKqYNrykvebst0JneJ66SigdG" ) );
